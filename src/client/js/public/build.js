...
function startGame() {
    ...
    if (validNick()) {
        ...
        // Init p5
        new _p5Min2.default(_game2.default);
    } else {
...
window.onload = function () {
    ...
    // Cookie loading
    var playerCookie = cookies.getCookie(global.NAME_COOKIE);
    var roomCookie = cookies.getCookie(global.ROOM_COOKIE);
    ...
    playerNameInput.addEventListener('keypress', function (e) {
        ...
        if (key === global.KEY_ENTER) startGame();
    });
};
...
},{"./chat-client.js":2,"./cookies.js":3,"./game.js":4,"./global.js":5,"./lib/p5.min.js":6}],2:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.ChatClient = undefined;
 ...
 *
 */
var ChatClient = exports.ChatClient = function () {
    /** 
    * MISSING COMMENT
    */
...
},{"./global.js":5}],3:[function(require,module,exports){
"use strict";
...
var game = function game(p5) {
  ...
  p5.draw = function () {
    ...
    var move = Math.sqrt(mouseXC ** 2 + mouseYC ** 2) > playerRadius;
...
},{"./lib/p5.min.js":6}],5:[function(require,module,exports){
'use strict';
...
/*! p5.js v0.6.0 January 19, 2018 */!function (a) {
  ...
  var a;return function a(b, c, d) {
    function e(g, h) {
      ...
      (function (e) {
        !function (b, e) {
          "object" == (typeof d === "undefined" ? "undefined" : _typeof(d)) && void 0 !== c ? e(d) : "function" == typeof a && a.amd ? a(["exports"], e) : e(b.opentype = b.opentype || {});
        }(this, function (a) {
          "use strict";
          function c() {
            ...
            var d, e, f, g, i, l;for (d = j(a, 5, 257), e = j(a, 5, 1), f = j(a, 4, 4), g = 0; g < 19; ++g) {
              ...
              var m = j(a, 3, 0);we[ue[g]] = m;
            }for (h(ve, we, 0, 19), i = 0; i < d + e;) {
              var n = k(a, ve);switch (n) {case 16:
                  var o = we[i - 1];for (l = j(a, 2, 3); l; --l) {
                    we[i++] = o;
                  }break;case 17:
                  for (l = j(a, 3, 3); l; --l) {
                    we[i++] = 0;
            ...
            for (;;) {
              var d = k(a, b);if (256 === d) return me;if (d < 256) a.dest[a.destLen++] = d;else {
                var e, f, g, h;for (d -= 257, e = j(a, qe[d], re[d]), f = k(a, c), g = a.destLen - j(a, se[f], te[f]), h = g; h < g + e; ++h) {
            ...
            }if (b = a.source[a.sourceIndex + 1], b = 256 * b + a.source[a.sourceIndex], c = a.source[a.sourceIndex + 3], c = 256 * c + a.source[a.sourceIndex + 2], b !== (65535 & ~c)) return ne;for (a.sourceIndex += 4, d = b; d; --d) {
            ...
            var c,
              ...
              switch (c = i(f), j(f, 2, 0)) {case 0:
                  e = n(f);break;case 1:
                  e = m(f, oe, pe);break;case 2:
                  l(f, f.ltree, f.dtree), e = m(f, f.ltree, f.dtree);break;default:
                  e = ne;}if (e !== me) throw new Error("Data error");
            ...
            z.call(this, "lookupListTable", B("lookup", a, function (a) {
              var c = b[a.lookupType];return ze.assert(!!c, "Unable to write GSUB lookup type " + a.lookupType + " tables."), new z("lookupTable", [{ name: "lookupType", type: "USHORT", value: a.lookupType }, { name: "lookupFlag", type: "USHORT", value: a.lookupFlag }].concat(B("subtable", a.subtables, c)));
            }));
          }function H(a, b) {
            return a.getUint8(b);
          }function I(a, b) {
            ...
            a.length = b.parseUShort(), a.language = b.parseUShort();var f;a.segCount = f = b.parseUShort() >> 1, b.skip("uShort", 3), a.glyphIndexMap = {};for (var g = new Ne.Parser(c, d + e + 14), h = new Ne.Parser(c, d + e + 16 + 2 * f), i = new Ne.Parser(c, d + e + 16 + 4 * f), j = new Ne.Parser(c, d + e + 16 + 6 * f), k = d + e + 16 + 8 * f, l = 0; l < f - 1; l += 1) {
            ...
            var c = {};c.version = Ne.getUShort(a, b), ze.argument(0 === c.version, "cmap table version should be 0."), c.numTables = Ne.getUShort(a, b + 2);for (var d = -1, e = c.numTables - 1; e >= 0; e -= 1) {
              var f = Ne.getUShort(a, b + 4 + 8 * e),
                  g = Ne.getUShort(a, b + 4 + 8 * e + 2);if (3 === f && (0 === g || 1 === g || 10 === g)) {
                d = Ne.getULong(a, b + 4 + 8 * e + 4);break;
              }
            }if (-1 === d) throw new Error("No valid cmap sub-tables found.");var h = new Ne.Parser(a, b + d);if (c.format = h.parseUShort(), 12 === c.format) R(c, h);else {
            ...
            var b = new Ke.Table("cmap", [{ name: "version", type: "USHORT", value: 0 }, { name: "numTables", type: "USHORT", value: 1 }, { name: "platformID", type: "USHORT", value: 3 }, { name: "encodingID", type: "USHORT", value: 1 }, { name: "offset", type: "ULONG", value: 12 }, { name: "format", type: "USHORT", value: 4 }, { name: "length", type: "USHORT", value: 0 }, { name: "language", type: "USHORT", value: 0 }, { name: "segCountX2", type: "USHORT", value: 0 }, { name: "searchRange", type: "USHORT", value: 0 }, { name: "entrySelector", type: "USHORT", value: 0 }, { name: "rangeShift", type: "USHORT", value: 0 }]);b.segments = [];for (var c = 0; c < a.length; c += 1) {
              ...
              var m = b.segments[l];g = g.concat({ name: "end_" + l, type: "USHORT", value: m.end }), h = h.concat({ name: "start_" + l, type: "USHORT", value: m.start }), i = i.concat({ name: "idDelta_" + l, type: "SHORT", value: m.delta }), j = j.concat({ name: "idRangeOffset_" + l, type: "USHORT", value: m.offset }), void 0 !== m.glyphId && (k = k.concat({ name: "glyph_" + l, type: "USHORT", value: m.glyphId }));
            ...
            var b = this;switch (a.version) {case 1:
                this.names = Se.slice();break;case 2:
            ...
            var d = new Ne.Parser(b, c);a.numberOfContours = d.parseShort(), a._xMin = d.parseShort(), a._yMin = d.parseShort(), a._xMax = d.parseShort(), a._yMax = d.parseShort();var e, f;if (a.numberOfContours > 0) {
            ...
            var b = new r();if (!a) return b;for (var c = ea(a), d = 0; d < c.length; ++d) {
              var e = c[d],
                  f = null,
                  g = e[e.length - 1],
                ...
                if (f = g, g = h, h = e[(j + 1) % e.length], g.onCurve) b.lineTo(g.x, g.y);else {
                  var k = f,
                      l = h;f.onCurve || (k = { x: .5 * (g.x + f.x), y: .5 * (g.y + f.y) }, b.lineTo(k.x, k.y)), h.onCurve || (l = { x: .5 * (g.x + h.x), y: .5 * (g.y + h.y) }), b.lineTo(k.x, k.y), b.quadraticCurveTo(g.x, g.y, l.x, l.y);
                }
              }b.closePath();
            }return b;
          }function ga(a, b) {
            if (b.isComposite) for (var c = 0; c < b.components.length; c += 1) {
              var d = b.components[c],
                ...
                var f = void 0;if (void 0 === d.matchedPoints) f = da(e.points, d);else {
                  if (d.matchedPoints[0] > b.points.length - 1 || d.matchedPoints[1] > e.points.length - 1) throw Error("Matched points out of range in " + b.name);var g = b.points[d.matchedPoints[0]],
                      ...
                      i = { xScale: d.xScale, scale01: d.scale01, scale10: d.scale10, yScale: d.yScale, dx: 0, dy: 0 };h = da([h], i)[0], i.dx = g.x - h.x, i.dy = g.y - h.y, f = da(e.points, i);
                }b.points = b.points.concat(f);
              }
            }return fa(b.points);
          }function ha(a, b, c, d) {
            for (var e = new Ve.GlyphSet(d), f = 0; f < c.length - 1; f += 1) {
              var g = c[f];g !== c[f + 1] ? e.push(f, Ve.ttfGlyphLoader(d, f, ca, a, b + g, ga)) : e.push(f, Ve.glyphLoader(d, f));
            }return e;
          }function ia(a, b) {
            ...
            return function () {
              var g = new ja({ index: b, font: a });return g.path = function () {
            ...
            return function () {
              var e = new ja({ index: b, font: a });return e.path = function () {
            ...
            var d,
                ...
                f = [],
                g = [],
                h = Ne.getCard16(a, b);if (0 !== h) {
              var i = Ne.getByte(a, b + 2);d = b + (h + 1) * i + 2;for (var j = b + 3, k = 0; k < h + 1; k += 1) {
                f.push(Ne.getOffset(a, j, i)), j += i;
              }e = d + f[h];
            } else e = b + 2;for (var l = 0; l < f.length - 1; l += 1) {
              var m = Ne.getBytes(a, d + f[l], d + f[l + 1]);c && (m = c(m)), g.push(m);
            ...
            b = void 0 !== b ? b : 0;var d = new Ne.Parser(a, b),
                e = [],
                f = [];for (c = void 0 !== c ? c : a.length; d.relativeOffset < c;) {
              var g = d.parseByte();g <= 21 ? (12 === g && (g = 1200 + d.parseByte()), e.push([g, f]), f = []) : f.push(ta(d, g));
            }return ua(e);
          }function wa(a, b) {
            ...
            var c = {};return c.formatMajor = Ne.getCard8(a, b), c.formatMinor = Ne.getCard8(a, b + 1), c.size = Ne.getCard8(a, b + 2), c.offsetSize = Ne.getCard8(a, b + 3), c.startOffset = b, c.endOffset = b + 4, c;
          }function za(a, b) {
            ...
            for (var e = [], f = 0; f < c.length; f += 1) {
              var g = new DataView(new Uint8Array(c[f]).buffer),
                  h = za(g, d);h._subrs = [], h._subrsBias = 0;var i = h.private[0],
                  j = h.private[1];if (0 !== i && 0 !== j) {
                var k = Aa(a, j + b, i, d);if (h._defaultWidthX = k.defaultWidthX, h._nominalWidthX = k.nominalWidthX, 0 !== k.subrs) {
                  var l = j + k.subrs,
                      m = ra(a, l + b);h._subrs = m.objects, h._subrsBias = qa(h._subrs);
                }h._privateDict = k;
              }e.push(h);
            }return e;
          }function Ca(a, b, c, d) {
            var e,
                f,
                g = new Ne.Parser(a, b);c -= 1;var h = [".notdef"],
            ...
            c.tables.cff = {};var d = ya(a, b),
              ...
              var k = j.fdArray,
                  l = j.fdSelect;if (0 === k || 0 === l) throw new Error("Font is marked as a CID font, but FDArray and/or FDSelect information is missing");k += b;var m = ra(a, k),
                  n = Ba(a, b, m.objects, g.objects);j._fdArray = n, l += b, j._fdSelect = Fa(a, l, c.numGlyphs, n.length);
            }var o = b + j.private[1],
                p = Aa(a, o, j.private[0], g.objects);if (c.defaultWidthX = p.defaultWidthX, c.nominalWidthX = p.nominalWidthX, 0 !== p.subrs) {
              var q = o + p.subrs,
                  r = ra(a, q);c.subrs = r.objects, c.subrsBias = qa(c.subrs);
            } else c.subrs = [], c.subrsBias = 0;var s = ra(a, b + j.charStrings);c.nGlyphs = s.objects.length;var t = Ca(a, b + j.charset, c.nGlyphs, g.objects);0 === j.encoding ? c.cffEncoding = new Z(Qe, t) : 1 === j.encoding ? c.cffEncoding = new Z(Re, t) : c.cffEncoding = Da(a, b + j.encoding, t), c.encoding = c.encoding || c.cffEncoding, c.glyphs = new Ve.GlyphSet(c);for (var u = 0; u < c.nGlyphs; u += 1) {
              var v = s.objects[u];c.glyphs.push(u, Ve.cffGlyphLoader(c, u, Ea, v));
            }
          }function Ha(a, b) {
            var c,
                d = Pe.indexOf(a);return d >= 0 && (c = d), d = b.indexOf(a), d >= 0 ? c = d + Pe.length : (c = Pe.length + b.length, b.push(a)), c;
          }function Ia() {
            ...
            var b = new Ke.Record("Name INDEX", [{ name: "names", type: "INDEX", value: [] }]);b.names = [];for (var c = 0; c < a.length; c += 1) {
              b.names.push({ name: "name_" + c, type: "NAME", value: a[c] });
            }return b;
          }function Ka(a, b, c) {
            for (var d = {}, e = 0; e < a.length; e += 1) {
              var f = a[e],
                  g = b[f.name];void 0 === g || pa(g, f.value) || ("SID" === f.type && (g = Ha(g, c)), d[f.op] = { name: f.name, type: f.type, value: g });
            }return d;
          }function La(a, b) {
            var c = new Ke.Record("Top DICT", [{ name: "dict", type: "DICT", value: {} }]);return c.dict = Ka(We, a, b), c;
          }function Ma(a) {
            var b = new Ke.Record("Top DICT INDEX", [{ name: "topDicts", type: "INDEX", value: [] }]);return b.topDicts = [{ name: "topDict_0", type: "TABLE", value: a }], b;
          }function Na(a) {
            var b = new Ke.Record("String INDEX", [{ name: "strings", type: "INDEX", value: [] }]);b.strings = [];for (var c = 0; c < a.length; c += 1) {
            ...
            for (var c = new Ke.Record("Charsets", [{ name: "format", type: "Card8", value: 0 }]), d = 0; d < a.length; d += 1) {
              var e = a[d],
                  f = Ha(e, b);c.fields.push({ name: "glyph_" + d, type: "SID", value: f });
            }return c;
          }function Qa(a) {
            var b = [],
            ...
            for (var b = new Ke.Record("CharStrings INDEX", [{ name: "charStrings", type: "INDEX", value: [] }]), c = 0; c < a.length; c += 1) {
              var d = a.get(c),
                  e = Qa(d);b.charStrings.push({ name: d.name, type: "CHARSTRING", value: e });
            }return b;
          }function Sa(a, b) {
            var c = new Ke.Record("Private DICT", [{ name: "dict", type: "DICT", value: {} }]);return c.dict = Ka(Xe, a, b), c;
          }function Ta(a, b) {
            ...
            var c = new Ne.Parser(a, b),
                d = c.parseULong();ze.argument(1 === d, "Unsupported ltag table version."), c.skip("uLong", 1);for (var e = c.parseULong(), f = [], g = 0; g < e; g++) {
            ...
            for (var d = {}, e = new Ne.Parser(a, b), f = e.parseUShort(), g = e.parseUShort(), h = e.offset + e.parseUShort(), i = 0; i < g; i++) {
              var j = e.parseUShort(),
                  ...
                  p = e.parseUShort(),
                  q = cb(j, l, c),
                  r = db(j, k, l);if (void 0 !== r && void 0 !== q) {
                var s = void 0;if (s = r === gf ? Ce.UTF16(a, h + p, o) : Ce.MACSTRING(a, h + p, o, r)) {
            ...
            var c,
              ...
              c = d[m];var n = e[c];for (var o in n) {
                var p = n[o],
                    ...
                    s = ef[r],
                    t = db(q, s, r),
                    u = De.MACSTRING(p, t);void 0 === u && (q = 0, r = b.indexOf(o), r < 0 && (r = b.length, b.push(o)), s = 4, u = De.UTF16(p));var v = ib(u, l);k.push(gb(q, s, r, c, u.length, v));var w = j[o];if (void 0 !== w) {
                  var x = De.UTF16(p),
                      y = ib(x, l);k.push(gb(3, 1, w, c, x.length, y));
                }
              }
            }k.sort(function (a, b) {
              return a.platformID - b.platformID || a.encodingID - b.encodingID || a.languageID - b.languageID || a.nameID - b.nameID;
            });for (var z = new Ke.Table("name", [{ name: "format", type: "USHORT", value: 0 }, { name: "count", type: "USHORT", value: k.length }, { name: "stringOffset", type: "USHORT", value: 6 + 12 * k.length }]), A = 0; A < k.length; A++) {
            ...
            var c = {},
                d = new Ne.Parser(a, b);switch (c.version = d.parseVersion(), c.italicAngle = d.parseFixed(), c.underlinePosition = d.parseShort(), c.underlineThickness = d.parseShort(), c.isFixedPitch = d.parseULong(), c.minMemType42 = d.parseULong(), c.maxMemType42 = d.parseULong(), c.minMemType1 = d.parseULong(), c.maxMemType1 = d.parseULong(), c.version) {case 1:
                c.names = Se.slice();break;case 2:
            ...
            var c = new Ne.Parser(a, b),
                d = c.parseULong();ze.argument(1 === d, "Unsupported META table version."), c.parseULong(), c.parseULong();for (var e = c.parseULong(), f = {}, g = 0; g < e; g++) {
              var h = c.parseTag(),
                  i = c.parseULong(),
                  j = c.parseULong(),
                  k = Ce.UTF8(a, b + i, j);f[h] = k;
            }return f;
          }function sb(a) {
            var b = Object.keys(a).length,
                c = "",
                d = 16 + 12 * b,
                e = new Ke.Table("meta", [{ name: "version", type: "ULONG", value: 1 }, { name: "flags", type: "ULONG", value: 0 }, { name: "offset", type: "ULONG", value: d }, { name: "numTags", type: "ULONG", value: b }]);for (var f in a) {
            ...
            var b = new Ke.Table("sfnt", [{ name: "version", type: "TAG", value: "OTTO" }, { name: "numTables", type: "USHORT", value: 0 }, { name: "searchRange", type: "USHORT", value: 0 }, { name: "entrySelector", type: "USHORT", value: 0 }, { name: "rangeShift", type: "USHORT", value: 0 }]);b.tables = a, b.numTables = a.length;var c = Math.pow(2, tb(b.numTables));b.searchRange = 16 * c, b.entrySelector = tb(c), b.rangeShift = 16 * b.numTables - b.searchRange;for (var d = [], e = [], f = b.sizeOf() + vb().sizeOf() * b.numTables; f % 4 != 0;) {
              f += 1, e.push({ name: "padding", type: "BYTE", value: 0 });
            }for (var g = 0; g < a.length; g += 1) {
              var h = a[g];ze.argument(4 === h.tableName.length, "Table name" + h.tableName + " is invalid.");var i = h.sizeOf(),
                  j = vb(h.tableName, ub(h.encode()), f, i);for (d.push({ name: j.tag + " Table Record", type: "RECORD", value: j }), e.push({ name: h.tableName + " table", type: "RECORD", value: h }), f += i, ze.argument(!isNaN(f), "Something went wrong calculating the offset."); f % 4 != 0;) {
                f += 1, e.push({ name: "padding", type: "BYTE", value: 0 });
              }
            ...
            for (var b, c = [], d = [], e = [], f = [], g = [], h = [], i = [], j = 0, k = 0, l = 0, m = 0, n = 0, o = 0; o < a.glyphs.length; o += 1) {
              var p = a.glyphs.get(o),
                  q = 0 | p.unicode;if (isNaN(p.advanceWidth)) throw new Error("Glyph " + p.name + " (" + o + "): advanceWidth is not a number.");(b > q || void 0 === b) && q > 0 && (b = q), j < q && (j = q);var r = mf.getUnicodeRange(q);if (r < 32) k |= 1 << r;else if (r < 64) l |= 1 << r - 32;else if (r < 96) m |= 1 << r - 64;else {
            ...
            }var t = { xMin: Math.min.apply(null, c), yMin: Math.min.apply(null, d), xMax: Math.max.apply(null, e), yMax: Math.max.apply(null, f), advanceWidthMax: Math.max.apply(null, g), advanceWidthAvg: yb(g), minLeftSideBearing: Math.min.apply(null, h), maxLeftSideBearing: Math.max.apply(null, h), minRightSideBearing: Math.min.apply(null, i) };t.ascender = a.ascender, t.descender = a.descender;var u = Ze.make({ flags: 3, unitsPerEm: a.unitsPerEm, xMin: t.xMin, yMin: t.yMin, xMax: t.xMax, yMax: t.yMax, lowestRecPPEM: 3, createdTimestamp: a.createdTimestamp }),
              ...
              E[F] = a.names[F];
                ...
                M = [u, v, w, x, H, z, J, K, y];I && M.push(I), a.tables.gsub && M.push(rf.make(a.tables.gsub)), L && M.push(L);for (var N = wb(M), O = N.encode(), P = ub(O), Q = N.fields, R = !1, S = 0; S < Q.length; S += 1) {
            ...
            var c = Math.sqrt(a * a + b * b);return a /= c, b /= c, 1 === a && 0 === b ? zf : 0 === a && 1 === b ? Af : new Rb(a, b);
          }function Tb(a, b, c, d) {
            ...
            var d = c.stack,
                ...
                f = d.pop(),
                g = c.z2[e],
                h = c.z1[f];a.DEBUG && console.log("SPVTL[" + b + "]", e, f);var i, j;b ? (i = g.y - h.y, j = h.x - g.x) : (i = h.x - g.x, j = h.y - g.y), c.pv = c.dpv = Sb(i, j);
          }function _b(b, c) {
            var d = c.stack,
                e = d.pop(),
                f = d.pop(),
                g = c.z2[e],
                h = c.z1[f];a.DEBUG && console.log("SFVTL[" + b + "]", e, f);var i, j;b ? (i = g.y - h.y, j = h.x - g.x) : (i = h.x - g.x, j = h.y - g.y), c.fv = Sb(i, j);
          }function ac(b) {
            var c = b.stack,
                d = c.pop(),
                e = c.pop();a.DEBUG && console.log(b.step, "SPVFS[]", d, e), b.pv = b.dpv = Sb(e, d);
          }function bc(b) {
            var c = b.stack,
                d = c.pop(),
                e = c.pop();a.DEBUG && console.log(b.step, "SPVFS[]", d, e), b.fv = Sb(e, d);
          }function cc(b) {
            var c = b.stack,
            ...
            var c = b.stack.pop();a.DEBUG && console.log(b.step, "CALL[]", c);var d = b.ip,
                e = b.prog;b.prog = b.funcs[c], vf(b), b.ip = d, b.prog = e, a.DEBUG && console.log(++b.step, "returning from", c);
          }function Bc(b) {
            var c = b.stack,
            ...
            var d = c.stack.pop(),
                e = c.z0[d],
                f = c.fv,
                g = c.pv;a.DEBUG && console.log(c.step, "MDAP[" + b + "]", d);var h = g.distance(e, Bf);b && (h = c.round(h)), f.setRelative(e, Bf, h, g), f.touch(e), c.rp0 = c.rp1 = d;
          }function Fc(b, c) {
            var d,
                e,
                f,
            ...
            var d = c.stack,
                ...
                h = c.fv,
                i = c.pv,
                j = c.cvt[e];b && (j = c.round(j)), a.DEBUG && console.log(c.step, "MIAP[" + b + "]", e, "(", j, ")", f), h.setRelative(g, Bf, j, i), 0 === c.zp0 && (g.xo = g.x, g.yo = g.y), h.touch(g), c.rp0 = c.rp1 = f;
          }function Pc(b) {
            var c = b.prog,
                d = b.ip,
                e = b.stack,
            ...
            var d = c.stack,
                e = d.pop(),
                f = c.z2[e];a.DEBUG && console.log(c.step, "GC[" + b + "]", e), d.push(64 * c.dpv.distance(f, Bf, b, !1));
          }function Wc(b, c) {
            var d = c.stack,
                e = d.pop(),
                f = d.pop(),
            ...
            var c,
                d = b.stack.pop();a.DEBUG && console.log(b.step, "IF[]", d), d || (Wb(b, !0), a.DEBUG && console.log(b.step, 27 === c ? "ELSE[]" : "EIF[]"));
          }function gd(b) {
            ...
            var c = b.stack.pop();a.DEBUG && console.log(b.step, "SROUND[]", c), b.round = yf;var d;switch (192 & c) {case 0:
                d = .5;break;case 64:
                d = 1;break;case 128:
                d = 2;break;default:
            ...
            var c = b.stack.pop();a.DEBUG && console.log(b.step, "S45ROUND[]", c), b.round = yf;var d;switch (192 & c) {case 0:
            ...
            var d = c.stack,
                ...
                f = d.pop(),
                g = c.z2[e],
                h = c.z1[f];a.DEBUG && console.log("SDPVTL[" + b + "]", e, f);var i, j;b ? (i = g.y - h.y, j = h.x - g.x) : (i = h.x - g.x, j = h.y - g.y), c.dpv = Sb(i, j);
          }function Fd(b) {
            var c = b.stack,
                d = c.pop(),
            ...
            var d = Pd(b.name, c);return [{ name: "tag_" + a, type: "TAG", value: b.tag }, { name: "minValue_" + a, type: "FIXED", value: b.minValue << 16 }, { name: "defaultValue_" + a, type: "FIXED", value: b.defaultValue << 16 }, { name: "maxValue_" + a, type: "FIXED", value: b.maxValue << 16 }, { name: "flags_" + a, type: "USHORT", value: 0 }, { name: "nameID_" + a, type: "USHORT", value: d }];
          }function Rd(a, b, c) {
            var d = {},
            ...
            var e = {},
                f = new Ne.Parser(a, b);e.name = d[f.parseUShort()] || {}, f.skip("uShort", 1), e.coordinates = {};for (var g = 0; g < c.length; ++g) {
            ...
            var d = new Ne.Parser(a, b),
                e = d.parseULong();ze.argument(65536 === e, "Unsupported fvar table version.");var f = d.parseOffset16();d.skip("uShort", 1);for (var g = d.parseUShort(), h = d.parseUShort(), i = d.parseUShort(), j = d.parseUShort(), k = [], l = 0; l < g; l++) {
            ...
            var c,
                ...
                g = Xd(a, b + f),
                h = d.parseUShort(),
                i = d.parseUShort();if (4 === h && 0 === i) {
              var j = {};if (1 === e) {
                for (var k = d.parseUShort(), l = [], m = d.parseOffset16List(k), n = 0; n < k; n++) {
                  var o = m[n],
                      p = j[o];if (!p) {
                    p = {}, d.relativeOffset = o;for (var q = d.parseUShort(); q--;) {
                      var r = d.parseUShort();h && (c = d.parseShort()), i && d.parseShort(), p[r] = c;
                    }
                  }l[g[n]] = p;
                }return function (a, b) {
                  var c = l[a];if (c) return c[b];
                };
              }if (2 === e) {
            ...
            var c = new Ne.Parser(a, b),
                ...
                i = { lookupType: d, lookupFlag: e, markFilteringSet: f ? c.parseUShort() : -1 };if (2 === d) {
              for (var j = [], k = 0; k < g; k++) {
                var l = Zd(a, b + h[k]);l && j.push(l);
              }i.getKerningValue = function (a, b) {
                for (var c = j.length; c--;) {
                  var d = j[c](a, b);if (void 0 !== d) return d;
                }return 0;
              };
            }return i;
          }function _d(a, b, c) {
            var d = new Ne.Parser(a, b),
                e = d.parseFixed();ze.argument(1 === e, "Unsupported GPOS table version."), Wd(a, b + d.parseUShort()), Wd(a, b + d.parseUShort());var f = d.parseUShort();d.relativeOffset = f;for (var g = d.parseUShort(), h = d.parseOffset16List(g), i = b + f, j = 0; j < g; j++) {
              var k = $d(a, i + h[j]);2 !== k.lookupType || c.getGposKerningValue || (c.getGposKerningValue = k.getKerningValue);
            }
          }function ae(a) {
            var b = {};a.skip("uShort");var c = a.parseUShort();ze.argument(0 === c, "Unsupported kern sub-table version."), a.skip("uShort", 2);var d = a.parseUShort();a.skip("uShort", 3);for (var e = 0; e < d; e += 1) {
              var f = a.parseUShort(),
                  g = a.parseUShort(),
            ...
            for (var c = [], d = 12, e = 0; e < b; e += 1) {
              var f = Ne.getTag(a, d),
                  g = Ne.getULong(a, d + 4),
                  h = Ne.getULong(a, d + 8),
                  i = Ne.getULong(a, d + 12);c.push({ tag: f, checksum: g, offset: h, length: i, compression: !1 }), d += 16;
            }return c;
          }function he(a, b) {
            ...
            if ("WOFF" === b.compression) {
              var c = new Uint8Array(a.buffer, b.offset + 2, b.compressedLength - 2),
                  d = new Uint8Array(b.length);if (ye(c, d), d.byteLength !== b.length) throw new Error("Decompression error: " + b.tag + " decompressed length doesn't match recorded length");return { data: new DataView(d.buffer, 0), offset: 0 };
            ...
            var b,
                ...
                f = new DataView(a, 0),
                g = [],
                h = Ne.getTag(f, 0);if (h === String.fromCharCode(0, 1, 0, 0) || "true" === h || "typ1" === h) e.outlinesFormat = "truetype", d = Ne.getUShort(f, 4), g = ge(f, d);else if ("OTTO" === h) e.outlinesFormat = "cff", d = Ne.getUShort(f, 4), g = ge(f, d);else {
              if ("wOFF" !== h) throw new Error("Unsupported OpenType signature " + h);var i = Ne.getTag(f, 4);if (i === String.fromCharCode(0, 1, 0, 0)) e.outlinesFormat = "truetype";else {
              ...
              var v = g[u],
                  ...
                  w = ie(f, v), e.tables.cmap = Oe.parse(w.data, w.offset), e.encoding = new Y(e.tables.cmap);break;case "cvt ":
                  w = ie(f, v), t = new Ne.Parser(w.data, w.offset), e.tables.cvt = t.parseShortList(v.length / 2);break;case "fvar":
                  k = v;break;case "fpgm":
                  w = ie(f, v), t = new Ne.Parser(w.data, w.offset), e.tables.fpgm = t.parseByteList(v.length);break;case "head":
                  w = ie(f, v), e.tables.head = Ze.parse(w.data, w.offset), e.unitsPerEm = e.tables.head.unitsPerEm, b = e.tables.head.indexToLocFormat;break;case "hhea":
                  w = ie(f, v), e.tables.hhea = $e.parse(w.data, w.offset), e.ascender = e.tables.hhea.ascender, e.descender = e.tables.hhea.descender, e.numberOfHMetrics = e.tables.hhea.numberOfHMetrics;break;case "hmtx":
                  o = v;break;case "ltag":
                  w = ie(f, v), c = af.parse(w.data, w.offset);break;case "maxp":
                  w = ie(f, v), e.tables.maxp = bf.parse(w.data, w.offset), e.numGlyphs = e.tables.maxp.numGlyphs;break;case "name":
                  r = v;break;case "OS/2":
                  w = ie(f, v), e.tables.os2 = mf.parse(w.data, w.offset);break;case "post":
                  w = ie(f, v), e.tables.post = nf.parse(w.data, w.offset), e.glyphNames = new $(e.tables.post);break;case "prep":
                  w = ie(f, v), t = new Ne.Parser(w.data, w.offset), e.tables.prep = t.parseByteList(v.length);break;case "glyf":
                  l = v;break;case "loca":
                  q = v;break;case "CFF ":
                  j = v;break;case "kern":
                  p = v;break;case "GPOS":
              ...
              var y = 0 === b,
                  ...
                  B = ie(f, l);e.glyphs = Ue.parse(B.data, B.offset, A, e);
            } else {
              if (!j) throw new Error("Font doesn't contain TrueType or CFF outlines.");var C = ie(f, j);Ye.parse(C.data, C.offset, e);
            }var D = ie(f, o);if (_e.parse(D.data, D.offset, e.numberOfHMetrics, e.numGlyphs, e.glyphs), _(e), p) {
              var E = ie(f, p);e.kerningPairs = Ff.parse(E.data, E.offset);
            } else e.kerningPairs = {};if (m) {
              var F = ie(f, m);Ef.parse(F.data, F.offset, e);
            }if (n) {
              var G = ie(f, n);e.tables.gsub = rf.parse(G.data, G.offset);
            }if (k) {
              var H = ie(f, k);e.tables.fvar = Df.parse(H.data, H.offset, e.names);
            }if (s) {
              var I = ie(f, s);e.tables.meta = sf.parse(I.data, I.offset), e.metas = e.tables.meta;
            }return e;
          }function ke(a, b) {
            ...
            return je(Hb(b("fs").readFileSync(a)));
              ...
              xe = new Uint16Array(16);g(oe, pe), f(qe, re, 4, 3), f(se, te, 2, 1), qe[28] = 0, re[28] = 258;var ye = o;q.prototype.isEmpty = function () {
            ...
            if (!Ge) {
              ...
              if (He) {
                var d = He.get(c);if (void 0 !== d) return d;
              }var e = Fe[a];if (void 0 !== e) {
            ...
            for (var b = 1, c = [b], d = [], e = 0; e < a.length; e += 1) {
              var f = De.OBJECT(a[e]);Array.prototype.push.apply(d, f), b += f.length, c.push(b);
            ...
            for (var b = [], c = Object.keys(a), d = c.length, e = 0; e < d; e += 1) {
              var f = parseInt(c[e], 0),
                  g = a[f];b = b.concat(De.OPERAND(g.value, g.type)), b = b.concat(De.OPERATOR(f));
            }return b;
          }, Ee.DICT = function (a) {
          ...
          }, De.OP = De.BYTE, Ee.OP = Ee.BYTE;var Je = "function" == typeof WeakMap && new WeakMap();De.CHARSTRING = function (a) {
            if (Je) {
              var b = Je.get(a);if (void 0 !== b) return b;
            }for (var c = [], d = a.length, e = 0; e < d; e += 1) {
              var f = a[e];c = c.concat(De[f.type](f.value));
            }return Je && Je.set(a, c), c;
          }, Ee.CHARSTRING = function (a) {
            return De.CHARSTRING(a).length;
          }, De.OBJECT = function (a) {
            var b = De[a.type];return ze.argument(void 0 !== b, "No encoding function for type " + a.type), b(a.value);
          }, Ee.OBJECT = function (a) {
            var b = Ee[a.type];return ze.argument(void 0 !== b, "No sizeOf function for type " + a.type), b(a.value);
          }, De.TABLE = function (a) {
            for (var b = [], c = a.fields.length, d = [], e = [], f = 0; f < c; f += 1) {
              var g = a.fields[f],
                  h = De[g.type];ze.argument(void 0 !== h, "No encoding function for field type " + g.type + " (" + g.name + ")");var i = a[g.name];void 0 === i && (i = g.value);var j = h(i);"TABLE" === g.type ? (e.push(b.length), b = b.concat([0, 0]), d.push(j)) : b = b.concat(j);
            }for (var k = 0; k < d.length; k += 1) {
              var l = e[k],
                  m = b.length;ze.argument(m < 65536, "Table " + a.tableName + " too big."), b[l] = m >> 8, b[l + 1] = 255 & m, b = b.concat(d[k]);
            }return b;
          }, Ee.TABLE = function (a) {
            for (var b = 0, c = a.fields.length, d = 0; d < c; d += 1) {
              var e = a.fields[d],
                  f = Ee[e.type];ze.argument(void 0 !== f, "No sizeOf function for field type " + e.type + " (" + e.name + ")");var g = a[e.name];void 0 === g && (g = e.value), b += f(g), "TABLE" === e.type && (b += 2);
            }return b;
            ...
            return Ee.TABLE(this);
              ...
              Le = { byte: 1, uShort: 2, short: 2, uLong: 4, fixed: 4, longDateTime: 8, tag: 4 };Q.prototype.parseByte = function () {
            ...
            var a = I(this.data, this.offset + this.relativeOffset),
                b = I(this.data, this.offset + this.relativeOffset + 2);return this.relativeOffset += 4, a + b / 4096 / 10;
          ...
          }, Q.tag = Q.prototype.parseTag, Q.byte = Q.prototype.parseByte, Q.uShort = Q.offset16 = Q.prototype.parseUShort, Q.uShortList = Q.prototype.parseUShortList, Q.struct = Q.prototype.parseStruct, Q.coverage = Q.prototype.parseCoverage, Q.classDef = Q.prototype.parseClassDef;var Me = { reserved: Q.uShort, reqFeatureIndex: Q.uShort, featureIndexes: Q.uShortList };Q.prototype.parseScriptList = function () {
            ...
            return this.parsePointer(Q.list(Q.pointer(function () {
              var b = this.parseUShort();ze.argument(1 <= b && b <= 8, "GSUB lookup type " + b + " unknown.");var c = this.parseUShort(),
            ...
            return this.names[a];
              ...
              Ue = { getPath: fa, parse: ha };ja.prototype.bindConstructorValues = function (a) {
            ...
            a = void 0 !== a ? a : 0, b = void 0 !== b ? b : 0, c = void 0 !== c ? c : 72;var f, g;d || (d = {});var h = d.xScale,
                i = d.yScale;if (d.hinting && e && e.hinting && (g = this.path && e.hinting.exec(this, c)), g) f = Ue.getPath(g).commands, a = Math.round(a), b = Math.round(b), h = i = 1;else {
            ...
            var e;b = void 0 !== b ? b : 0, c = void 0 !== c ? c : 0, d = void 0 !== d ? d : 24, e = 1 / this.path.unitsPerEm * d, a.lineWidth = 1, a.strokeStyle = "black", Te.line(a, b, -1e4, b, 1e4), Te.line(a, -1e4, c, 1e4, c);var f = this.xMin || 0,
                g = this.yMin || 0,
                h = this.xMax || 0,
                i = this.yMax || 0,
                j = this.advanceWidth || 0;a.strokeStyle = "blue", Te.line(a, b + f * e, -1e4, b + f * e, 1e4), Te.line(a, b + h * e, -1e4, b + h * e, 1e4), Te.line(a, -1e4, c + -g * e, 1e4, c + -g * e), Te.line(a, -1e4, c + -i * e, 1e4, c + -i * e), a.strokeStyle = "green", Te.line(a, b + j * e, -1e4, b + j * e, 1e4);
            ...
            var a = this.offset + this.relativeOffset,
                b = this.parseUShort();return 1 === b ? { substFormat: 1, coverage: this.parsePointer(Q.coverage), deltaGlyphId: this.parseUShort() } : 2 === b ? { substFormat: 2, coverage: this.parsePointer(Q.coverage), substitute: this.parseOffset16List() } : void ze.assert(!1, "0x" + a.toString(16) + ": lookup type 1 format must be 1 or 2.");
          }, of[2] = function () {
            var a = this.parseUShort();return ze.argument(1 === a, "GSUB Multiple Substitution Subtable identifier-format must be 1"), { substFormat: a, coverage: this.parsePointer(Q.coverage), sequences: this.parseListOfLists() };
          }, of[3] = function () {
            var a = this.parseUShort();return ze.argument(1 === a, "GSUB Alternate Substitution Subtable identifier-format must be 1"), { substFormat: a, coverage: this.parsePointer(Q.coverage), alternateSets: this.parseListOfLists() };
          }, of[4] = function () {
            var a = this.parseUShort();return ze.argument(1 === a, "GSUB ligature table identifier-format must be 1"), { substFormat: a, coverage: this.parsePointer(Q.coverage), ligatureSets: this.parseListOfLists(function () {
                return { ligGlyph: this.parseUShort(), components: this.parseUShortList(this.parseUShort() - 1) };
              }) };
          };var pf = { sequenceIndex: Q.uShort, lookupListIndex: Q.uShort };of[5] = function () {
            var a = this.offset + this.relativeOffset,
                ...
                var a = this.parseUShort(),
                    b = this.parseUShort();return { input: this.parseUShortList(a - 1), lookupRecords: this.parseRecordList(b, pf) };
                ...
                var a = this.parseUShort(),
                    b = this.parseUShort();return { classes: this.parseUShortList(a - 1), lookupRecords: this.parseRecordList(b, pf) };
              }) };if (3 === b) {
            ...
            var a = this.parseUShort();ze.argument(1 === a, "GSUB Extension Substitution subtable identifier-format must be 1");var b = this.parseUShort(),
                c = new Q(this.data, this.offset + this.parseULong());return { substFormat: 1, lookupType: b, extension: of[b].call(c) };
          }, of[8] = function () {
            ...
            return ze.assert(1 === a.substFormat, "Lookup type 4 substFormat must be 1."), new Ke.Table("substitutionTable", [{ name: "substFormat", type: "USHORT", value: 1 }, { name: "coverage", type: "TABLE", value: new Ke.Coverage(a.coverage) }].concat(Ke.tableList("ligSet", a.ligatureSets, function (a) {
              ...
              sf = { parse: rb, make: sb },
              tf = { make: wb, fontToTable: zb, computeCheckSum: ub };Cb.prototype = { searchTag: Ab, binSearch: Bb, getTable: function getTable(a) {
              ...
              var c = this.getTable(b);if (c) {
                a = a || "DFLT";var d = c.scripts,
                    e = Ab(c.scripts, a);if (e >= 0) return d[e].script;if (b) {
              ...
              var d = this.getScriptTable(a, c);if (d) {
                if (!b || "dflt" === b || "DFLT" === b) return d.defaultLangSys;var e = Ab(d.langSysRecords, b);if (e >= 0) return d.langSysRecords[e].langSys;if (c) {
              ...
              var e = this.getLangSysTable(a, b, d);if (e) {
                for (var f, g = e.featureIndexes, h = this.font.tables[this.tableName].features, i = 0; i < g.length; i++) {
                  ...
                  var j = h.length;return ze.assert(0 === j || c >= h[j - 1].tag, "Features must be added in alphabetical order."), f = { tag: c, feature: { params: 0, lookupListIndexes: [] } }, h.push(f), g.push(j), f.feature;
                }
              }
            ...
            var e = this.getLookupTables(c, d, a, 1, !0)[0],
                f = Fb(e, 2, { substFormat: 2, coverage: { format: 1, glyphs: [] }, substitute: [] });ze.assert(1 === f.coverage.format, "Ligature: unable to modify coverage table format " + f.coverage.format);var g = b.sub,
            ...
            var e = this.getLookupTables(c, d, a, 3, !0)[0],
                f = Fb(e, 1, { substFormat: 1, coverage: { format: 1, glyphs: [] }, alternateSets: [] });ze.assert(1 === f.coverage.format, "Ligature: unable to modify coverage table format " + f.coverage.format);var g = b.sub,
            ...
            var e = this.getLookupTables(c, d, a, 4, !0)[0],
                f = e.subtables[0];f || (f = { substFormat: 1, coverage: { format: 1, glyphs: [] }, ligatureSets: [] }, e.subtables[0] = f), ze.assert(1 === f.coverage.format, "Ligature: unable to modify coverage table format " + f.coverage.format);var g = b.sub[0],
                h = b.sub.slice(1),
            ...
            var b = this.srPeriod,
              ...
              zf = { x: 1, y: 0, axis: "x", distance: function distance(a, b, c, d) {
              ...
              Af = { x: 0, y: 1, axis: "y", distance: function distance(a, b, c, d) {
            ...
            for (var b = this.prevPointOnContour; !a.touched(b) && b !== this;) {
              ...
              Cf = { cvCutIn: 17 / 16, deltaBase: 9, deltaShift: .125, loop: 1, minDis: 1, autoFlip: !0 };Kb.prototype.exec = function (b, c) {
            if ("number" != typeof c) throw new Error("Point size is not a number!");if (!(this._errorState > 2)) {
              var d = this.font,
                ...
                }Ub.prototype = f, e = this._prepState = new Ub("prep", d.tables.prep), e.ppem = c;var g = d.tables.cvt;if (g) for (var h = e.cvt = new Array(g.length), i = c / d.unitsPerEm, j = 0; j < g.length; j++) {
                  h[j] = g[j] * i;
            ...
            var d,
                ...
                h = g,
                i = b.components;if (Ub.prototype = c, i) {
              var j = c.font;e = [], d = [];for (var k = 0; k < i.length; k++) {
                var l = i[k],
                    m = j.glyphs.get(l.glyphIndex);f = new Ub("glyf", m.instructions), a.DEBUG && (console.log("---EXEC COMP " + k + "---"), f.step = -1), xf(m, f, g, h);for (var n = Math.round(l.dx * g), o = Math.round(l.dy * h), p = f.gZone, q = f.contours, r = 0; r < p.length; r++) {
            ...
            for (var f, g = b.points || [], h = g.length, i = c.gZone = c.z0 = c.z1 = c.z2 = [], j = c.contours = [], k = 0; k < h; k++) {
              ...
              console.log("FINISHED GLYPH", c.stack);for (var o = 0; o < h; o++) {
            ...
            var c = this;b = b || this.defaultRenderOptions;for (var d = [], e = 0; e < a.length; e += 1) {
              var f = a[e];d.push(c.charToGlyphIndex(f));
            }var g = d.length;if (b.features) {
              var h = b.script || this.substitution.getDefaultScriptName(),
                  i = [];b.features.liga && (i = i.concat(this.substitution.getFeature("liga", h, b.language))), b.features.rlig && (i = i.concat(this.substitution.getFeature("rlig", h, b.language)));for (var j = 0; j < g; j += 1) {
            ...
            var g = this;b = void 0 !== b ? b : 0, c = void 0 !== c ? c : 0, d = void 0 !== d ? d : 72, e = e || this.defaultRenderOptions;for (var h = 1 / this.unitsPerEm * d, i = this.stringToGlyphs(a, e), j = 0; j < i.length; j += 1) {
              var k = i[j];if (f.call(g, k, b, c, d, e), k.advanceWidth && (b += k.advanceWidth * h), e.kerning && j < i.length - 1) {
            ...
            function a(a, b) {
              ...
              var c = d.getEnglishName(b);a(c && c.trim().length > 0, "No English " + b + " specified.");
            }var c = [],
                d = this;b("fontFamily"), b("weightName"), b("manufacturer"), b("copyright"), b("version"), a(this.unitsPerEm > 0, "No unitsPerEm specified.");
            ...
            var c = this.getEnglishName("fontFamily"),
                d = this.getEnglishName("fontSubfamily");a = a || c.replace(/\s/g, "") + "-" + d + ".otf";var e = this.toArrayBuffer();if (Gb()) window.requestFileSystem = window.requestFileSystem || window.webkitRequestFileSystem, window.requestFileSystem(window.TEMPORARY, e.byteLength, function (b) {
      ...
      var d = a("../core/core"),
        ...
        var i = arguments.length,
            j = this.mode,
            k = this.maxes,
            m = [];if (i >= 3) return m[0] = a / k[j][0], m[1] = b / k[j][1], m[2] = c / k[j][2], m[3] = "number" == typeof h ? h / k[j][3] : 1, m = m.map(function (a) {
          return Math.max(Math.min(a, 1), 0);
        }), j === e.HSL ? f._hslaToRGBA(m) : j === e.HSB ? f._hsbaToRGBA(m) : m;if (1 === i && "string" == typeof a) {
          var n = a.trim().toLowerCase();if (g[n]) return d.Color._parseInputs.call(this, g[n]);if (l.HEX3.test(n)) return m = l.HEX3.exec(n).slice(1).map(function (a) {
            return parseInt(a + a, 16) / 255;
          }), m[3] = 1, m;if (l.HEX6.test(n)) return m = l.HEX6.exec(n).slice(1).map(function (a) {
            return parseInt(a, 16) / 255;
          }), m[3] = 1, m;if (l.HEX4.test(n)) return m = l.HEX4.exec(n).slice(1).map(function (a) {
            return parseInt(a + a, 16) / 255;
            ...
            return a / 255;
          }), m[3] = 1, m;if (l.RGB_PERCENT.test(n)) return m = l.RGB_PERCENT.exec(n).slice(1).map(function (a) {
            return parseFloat(a) / 100;
          }), m[3] = 1, m;if (l.RGBA.test(n)) return m = l.RGBA.exec(n).slice(1).map(function (a, b) {
      ...
      var d = a("./core"),
          e = a("./constants"),
          f = a("./canvas");a("./error_helpers"), d.prototype.arc = function (a, b, c, f, g, h, i) {
        if (d._validateParameters("arc", arguments), !this._renderer._doStroke && !this._renderer._doFill) return this;for (this._angleMode === e.DEGREES && (g = this.radians(g), h = this.radians(h)); g < 0;) {
          g += e.TWO_PI;
        }for (; h < 0;) {
          h += e.TWO_PI;
        ...
        if (d._validateParameters("ellipse", arguments), c < 0 && (c = Math.abs(c)), void 0 === e ? e = c : e < 0 && (e = Math.abs(e)), this._renderer._doStroke || this._renderer._doFill) {
          var i = f.modeAdjust(a, b, c, e, this._renderer._ellipseMode);this._renderer.ellipse([i.x, i.y, i.w, i.h, g, h]);
        }return this;
        ...
        if (d._validateParameters("rect", arguments), this._renderer._doStroke || this._renderer._doFill) {
          var i = f.modeAdjust(a, b, c, e, this._renderer._rectMode);this._renderer.rect([i.x, i.y, i.w, i.h, g, h]);
        }return this;
        ...
        "boolean" == typeof b && void 0 === c && (c = b, b = void 0), this._setupDone = !1, this._pixelDensity = Math.ceil(window.devicePixelRatio) || 1, this._userNode = b, this._curElement = null, this._elements = [], this._requestAnimId = 0, this._preloadCount = 0, this._isGlobal = !1, this._loop = !0, this._initializeInstanceVariables(), this._defaultCanvasSize = { width: 100, height: 100 }, this._events = { mousemove: null, mousedown: null, mouseup: null, dragend: null, dragover: null, click: null, dblclick: null, mouseover: null, mouseout: null, keydown: null, keyup: null, keypress: null, touchstart: null, touchmove: null, touchend: null, resize: null, blur: null }, this._events.wheel = null, this._loadingScreenId = "p5_loading", this._registeredMethods = {};for (var d = Object.getOwnPropertyNames(e.prototype._registeredMethods), f = 0; f < d.length; f++) {
          ...
          this._userNode && "string" == typeof this._userNode && (this._userNode = document.getElementById(this._userNode));var a = this.preload || window.preload;if (a) {
            var b = document.getElementById(this._loadingScreenId);if (!b) {
              ...
              this._preloadMethods[c] = this._preloadMethods[c] || e;var d = this._preloadMethods[c];d !== e.prototype && d !== e || (d = this._isGlobal ? window : this), this._registeredPreloadMethods[c] = d[c], d[c] = this._wrapPreload(d, c);
      ...
      "use strict";
      var d = a("./core");a("./error_helpers"), d.prototype.bezier = function () {
      ...
      function d() {
        ...
        document.exitFullscreen ? document.exitFullscreen() : document.mozCancelFullScreen ? document.mozCancelFullScreen() : document.webkitExitFullscreen ? document.webkitExitFullscreen() : document.msExitFullscreen && document.msExitFullscreen();
          ...
          i = a("./constants"),
          j = [i.ARROW, i.CROSS, i.HAND, i.MOVE, i.TEXT, i.WAIT];h.prototype._frameRate = 0, h.prototype._lastFrameTime = window.performance.now(), h.prototype._targetFrameRate = 60;var k = window.print;h.prototype.print = function (a) {
      ...
      "use strict";
      var d = a("./core");a("./constants");d._validateParameters = d._friendlyFileLoadError = function () {};var e = null,
      ...
      }var g = a("./core");g.Element = function (a, b) {
      ...
      var d = a("./core"),
        ...
        if (void 0 === a && void 0 === b && void 0 === c && void 0 === e ? (a = 0, b = 0, c = this.width, e = this.height) : void 0 === c && void 0 === e && (c = 1, e = 1), a + c < 0 || b + e < 0 || a > this.width || b > this.height) return [0, 0, 0, 255];var f = this._pInst || this;f.loadPixels();var g = f._pixelDensity;a = Math.floor(a), b = Math.floor(b), c = Math.floor(c), e = Math.floor(e);var h = a * g,
        ...
        }var o = this.drawingContext.getImageData(h, i, 1, 1).data;return [o[0], o[1], o[2], o[3]];
        ...
        } else if (!c && d && this._getStroke() === h) return this;var j = .5522847498,
            k = g / 2 * j,
            l = i / 2 * j,
            m = e + g,
            n = f + i,
        ...
        var e = this.drawingContext;return this._doStroke ? this._getStroke() === h ? this : (e.lineWidth % 2 == 1 && e.translate(.5, .5), e.beginPath(), e.moveTo(a, b), e.lineTo(c, d), e.stroke(), e.lineWidth % 2 == 1 && e.translate(-.5, -.5), this) : this;
      }, d.Renderer2D.prototype.point = function (a, b) {
        var c = this.drawingContext;if (!this._doStroke) return this;if (this._getStroke() === h) return this;var d = this._getStroke(),
            e = this._getFill();a = Math.round(a), b = Math.round(b), this._setFill(d), c.lineWidth > 1 ? (c.beginPath(), c.arc(a, b, c.lineWidth / 2, 0, f.TWO_PI, !1), c.fill()) : c.fillRect(a, b, 1, 1), this._setFill(e);
        ...
        var b = a[0],
          ...
          void 0 === g && (g = f), void 0 === i && (i = g), void 0 === j && (j = i);var n = d / 2,
              o = e / 2;d < 2 * f && (f = n), e < 2 * f && (f = o), d < 2 * g && (g = n), e < 2 * g && (g = o), d < 2 * i && (i = n), e < 2 * i && (i = o), d < 2 * j && (j = n), e < 2 * j && (j = o), k.beginPath(), k.moveTo(b + f, c), k.arcTo(b + d, c, b + d, c + e, g), k.arcTo(b + d, c + e, b, c + e, i), k.arcTo(b, c + e, b, c, j), k.arcTo(b, c, b + d, c, f), k.closePath();
      ...
      var d = a("./core"),
        ...
        d._validateParameters("createCanvas", arguments);var g,
            h = c || e.P2D;if (h === e.WEBGL) {
          if (g = document.getElementById(f)) {
            g.parentNode.removeChild(g);var i = this._renderer;this._elements = this._elements.filter(function (a) {
              return a !== i;
            });
          }g = document.createElement("canvas"), g.id = f;
        } else if (this._defaultGraphicsCreated) g = this.canvas;else {
          g = document.createElement("canvas");for (var j = 0; document.getElementById("defaultCanvas" + j);) {
            j++;
        ...
        if (d._validateParameters("resizeCanvas", arguments), this._renderer) {
          ...
          }this._renderer.resize(a, b);for (var h in e) {
            try {
      ...
      function d(a, b) {
        for (var c = 1; c < arguments.length; c++) {
          var d = arguments[c];if (null != d) for (var e in d) {
            d.hasOwnProperty(e) && (a[e] = d[e]);
          }
        }
      }var e = a("./core");e.prototype.exit = function () {
        ...
        this._renderer.pop();var a = this._styles.pop();d(this._renderer, a.renderer), d(this, a.props);
      }, e.prototype.pushStyle = function () {
        throw new Error("pushStyle() not used, see push()");
      }, e.prototype.popStyle = function () {
        throw new Error("popStyle() not used, see pop()");
      }, e.prototype.redraw = function (a) {
        this.resetMatrix(), this._renderer.isP3D && this._renderer._update();var b = parseInt(a);(isNaN(b) || b < 1) && (b = 1);var c = this.setup || window.setup,
            d = this.draw || window.draw;if ("function" == typeof d) {
          void 0 === c && this.scale(this._pixelDensity, this._pixelDensity);for (var e = this, f = function f(a) {
            a.call(e);
          }, g = 0; g < b; g++) {
      ...
      var d = a("./core"),
        ...
        d._validateParameters("rotate", arguments);var c;return this._angleMode === e.DEGREES ? c = this.radians(a) : this._angleMode === e.RADIANS && (c = a), this._renderer.rotate(c, b), this;
      ...
      var d = a("./core"),
        ...
        if (d._validateParameters("bezierVertex", arguments), 0 === g.length) throw "vertex() must be used once before calling bezierVertex()";i = !0;for (var k = [], m = 0; m < arguments.length; m++) {
          k[m] = arguments[m];
        ...
        if (d._validateParameters("quadraticVertex", arguments), this._contourInited) {
          var i = {};return i.x = a, i.y = b, i.x3 = c, i.y3 = f, i.type = e.QUADRATIC, this._contourVertices.push(i), this;
        }if (!(g.length > 0)) throw "vertex() must be used once before calling quadraticVertex()";k = !0;for (var j = [], m = 0; m < arguments.length; m++) {
          j[m] = arguments[m];
      ...
      "use strict";
      var d = a("../core/core");d.prototype.createStringDict = function (a, b) {
        ...
        if (0 === Object.keys(this.data).length) throw "Unable to search for a minimum or maximum value on an empty NumberDict";if (1 === Object.keys(this.data).length) return this.data[Object.keys(this.data)[0]];var b = this.data[Object.keys(this.data)[0]];for (var c in this.data) {
        ...
        if (0 === Object.keys(this.data).length) throw "Unable to use minValue on an empty NumberDict";if (1 === Object.keys(this.data).length) return Object.keys(this.data)[0];for (var b = Object.keys(this.data)[0], c = 1; c < Object.keys(this.data).length; c++) {
      ...
      function d() {
        ...
        var b = this.keyReleased || window.keyReleased;f[a.which] = !1, d() || (this._setProperty("isKeyPressed", !1), this._setProperty("keyIsPressed", !1)), this._setProperty("_lastKeyCodeTyped", null);var c = String.fromCharCode(a.which);if (c || (c = a.which), this._setProperty("key", c), this._setProperty("keyCode", a.which), "function" == typeof b) {
      ...
      function d(a, b, c, d, e) {
        ...
        var b = this._isGlobal ? window : this;this._setProperty("mouseIsPressed", !0), this._updateTouchCoords(a), this._updateNextMouseCoords(a), "function" == typeof b.touchStarted ? !1 === b.touchStarted(a) && a.preventDefault() : "function" == typeof b.mousePressed && !1 === b.mousePressed(a) && a.preventDefault();
      ...
      var d = a("../core/core"),
        ...
        d._validateParameters("saveCanvas", arguments), a instanceof d.Element ? a = a.elt : a instanceof HTMLCanvasElement || (b = a, c = b, a = this._curElement && this._curElement.elt), c = c || d.prototype._checkFileExtension(b, c)[1] || "png";var e;switch (c) {default:
            e = "image/png";break;case "jpeg":case "jpg":
            e = "image/jpeg";}a.toBlob(function (a) {
      ...
      function d(a, b) {
      ...
      }var h = a("../core/core");a("whatwg-fetch"), a("es6-promise").polyfill();var i = a("fetch-jsonp");a("../core/error_helpers"), h.prototype.loadJSON = function () {
        ...
        }var i = this;return this.httpDo(d, "GET", c, f, function (b) {
          for (var c in b) {
            e[c] = b[c];
        ...
        }var f = this;return h.prototype.httpDo.call(this, arguments[0], "GET", "text", function (b) {
          var d = b.match(/[^\r\n]+/g);for (var e in d) {
            c[e] = d[e];
        ...
        var b,
          ...
          if ("function" == typeof arguments[k]) void 0 === b ? b = arguments[k] : void 0 === c && (c = arguments[k]);else if ("string" == typeof arguments[k]) if (e.push(arguments[k]), "header" === arguments[k] && (f = !0), "csv" === arguments[k]) {
            ...
            m = this;return this.httpDo(a, "GET", "text", function (a) {
        ...
        var a = Array.prototype.slice.call(arguments);a.splice(1, 0, "GET"), h.prototype.httpDo.apply(this, a);
      }, h.prototype.httpPost = function () {
        var a = Array.prototype.slice.call(arguments);a.splice(1, 0, "POST"), h.prototype.httpDo.apply(this, a);
      }, h.prototype.httpDo = function () {
        for (var a, b, c, d = "", e = {}, f = 0, g = "text/plain", h = arguments.length - 1; h > 0 && "function" == typeof arguments[h]; h--) {
          f++;
        }if (2 == arguments.length - f && "string" == typeof arguments[0] && "object" == _typeof(arguments[1])) c = new Request(arguments[0], arguments[1]), a = arguments[2], b = arguments[3], "" === d && (d = -1 !== c.url.indexOf("json") ? "json" : -1 !== c.url.indexOf("xml") ? "xml" : "text");else {
          for (var j, k = arguments[0], l = "GET", m = 1; m < arguments.length; m++) {
            var n = arguments[m];if ("string" == typeof n) "GET" === n || "POST" === n || "PUT" === n || "DELETE" === n ? l = n : "json" === n || "jsonp" === n || "xml" === n || "text" === n ? d = n : j = n;else if ("number" == typeof n) j = n.toString();else if ("object" == (typeof n === "undefined" ? "undefined" : _typeof(n))) {
        ...
        var d;d = void 0 === c ? b.substring(b.lastIndexOf(".") + 1, b.length) : c;var f = this.createWriter(b, d),
            g = a.columns,
            h = ",";if ("tsv" === d && (h = "\t"), "html" !== d) {
          if ("0" !== g[0]) {
            ...
            var k;for (k = 0; k < a.rows[j].arr.length; k++) {
              k < a.rows[j].arr.length - 1 ? f.write(a.rows[j].arr[k] + h) : (a.rows.length, f.write(a.rows[j].arr[k]));
            }f.write("\n");
          }
        } else {
          f.print("<html>"), f.print("<head>");var l = '  <meta http-equiv="content-type" content';if (l += '="text/html;charset=utf-8" />', f.print(l), f.print("</head>"), f.print("<body>"), f.print("  <table>"), "0" !== g[0]) {
            f.print("    <tr>");for (var m = 0; m < g.length; m++) {
              var n = e(g[m]);f.print("      <td>" + n), f.print("      </td>");
            }f.print("    </tr>");
          }for (var o = 0; o < a.rows.length; o++) {
            f.print("    <tr>");for (var p = 0; p < a.columns.length; p++) {
              var q = a.rows[o].getString(p),
                  r = e(q);f.print("      <td>" + r), f.print("      </td>");
            }f.print("    </tr>");
          }f.print("  </table>"), f.print("</body>"), f.print("</html>");
        }f.close(), f.flush();
      }, h.prototype.writeFile = function (a, b, c) {
        var d = "application/octet-stream";h.prototype._isSafari() && (d = "text/plain");var e = new Blob(a, { type: d });h.prototype.downloadFile(e, b, c);
      }, h.prototype.downloadFile = function (b, c, d) {
        var e = f(c, d),
            i = e[0];if (b instanceof Blob) {
          return void a("file-saver").saveAs(b, i);
        }var j = document.createElement("a");if (j.href = b, j.download = i, j.onclick = function (a) {
      ...
      var d = a("../core/core");d.Table = function (a) {
        ...
        var b = a || new d.TableRow();if (void 0 === b.arr || void 0 === b.obj) throw "invalid TableRow: " + b;return b.table = this, this.rows.push(b), b;
      ...
      var d = a("../core/core"),
        ...
        var a, b, c;arguments[0] instanceof d ? (this.p5 = arguments[0], a = arguments[1][0] || 0, b = arguments[1][1] || 0, c = arguments[1][2] || 0) : (a = arguments[0] || 0, b = arguments[1] || 0, c = arguments[2] || 0), this.x = a, this.y = b, this.z = c, this.name = "p5.Vector";
        ...
        var b = this.dot(a) / (this.mag() * a.mag()),
            c = Math.acos(Math.min(1, Math.max(-1, b)));return this.p5 && this.p5._angleMode === f.DEGREES && (c = e.radiansToDegrees(c)), c;
        ...
        this.p5 && this.p5._angleMode === f.DEGREES && (a = e.degreesToRadians(a), b = e.degreesToRadians(b)), void 0 === c && (c = 1);var g = Math.cos(b),
            h = Math.sin(b),
            i = Math.cos(a),
            j = Math.sin(a);return this.p5 ? new new d.Vector(this.p5, c * j * h, -c * i, c * j * g)() : new d.Vector(c * j * h, -c * i, c * j * g);
      }, d.Vector.random2D = function () {
        var a;return a = this.p5 ? this.p5._angleMode === f.DEGREES ? this.p5.random(360) : this.p5.random(f.TWO_PI) : Math.random() * f.TWO_PI, this.fromAngle(a);
      }, d.Vector.random3D = function () {
        var a, b;this.p5 ? (a = this.p5.random(0, f.TWO_PI), b = this.p5.random(-1, 1)) : (a = Math.random() * f.TWO_PI, b = 2 * Math.random() - 1);var c = Math.sqrt(1 - b * b),
            e = c * Math.cos(a),
            g = c * Math.sin(a);return this.p5 ? new d.Vector(this.p5, [e, g, b]) : new d.Vector(e, g, b);
      ...
      function d(a, b, c) {
        ...
        return parseFloat(a) > 0 ? " " + a.toString() : a.toString();
      }var h = a("../core/core");a("../core/error_helpers"), h.prototype.join = function (a, b) {
      ...
      "use strict";
      var d = a("../core/core");d.prototype.camera = function () {
        return this._renderer.camera.apply(this._renderer, arguments), this;
      }, d.RendererGL.prototype.camera = function (a, b, c, d, e, f, g, h, i) {
        void 0 === a && (a = this.defaultCameraX, b = this.defaultCameraY, c = this.defaultCameraZ, d = a, e = b, f = 0, g = 0, h = 1, i = 0), this.cameraX = a, this.cameraY = b, this.cameraZ = c;var j = a - d,
            k = b - e,
            l = c - f;this.eyeDist = Math.sqrt(j * j + k * k + l * l), 0 !== this.eyeDist && (j /= this.eyeDist, k /= this.eyeDist, l /= this.eyeDist);var m = g,
            n = h,
            o = i,
            p = n * l - o * k,
            q = -m * l + o * j,
            r = m * k - n * j;m = k * r - l * q, n = -j * r + l * p, o = j * q - k * p;var s = Math.sqrt(p * p + q * q + r * r);0 !== s && (p /= s, q /= s, r /= s);var t = Math.sqrt(m * m + n * n + o * o);0 !== t && (m /= t, n /= t, o /= t), this.cameraMatrix.set(p, m, j, 0, q, n, k, 0, r, o, l, 0, 0, 0, 0, 1);var u = -a,
            v = -b,
            w = -c;return this.cameraMatrix.translate([u, v, w]), this.uMVMatrix.set(this.cameraMatrix.mat4[0], this.cameraMatrix.mat4[1], this.cameraMatrix.mat4[2], this.cameraMatrix.mat4[3], this.cameraMatrix.mat4[4], this.cameraMatrix.mat4[5], this.cameraMatrix.mat4[6], this.cameraMatrix.mat4[7], this.cameraMatrix.mat4[8], this.cameraMatrix.mat4[9], this.cameraMatrix.mat4[10], this.cameraMatrix.mat4[11], this.cameraMatrix.mat4[12], this.cameraMatrix.mat4[13], this.cameraMatrix.mat4[14], this.cameraMatrix.mat4[15]), this;
        ...
        void 0 === a && (a = this.defaultCameraFOV), void 0 === b && (b = this.defaultCameraAspect), void 0 === c && (c = this.defaultCameraNear), void 0 === e && (e = this.defaultCameraFar), this.cameraFOV = a, this.cameraAspect = b, this.cameraNear = c, this.cameraFar = e, this.uPMatrix = d.Matrix.identity(this.pInst);var f = 1 / Math.tan(this.cameraFOV / 2),
            g = 1 / (this.cameraNear - this.cameraFar);this.uPMatrix.set(f / b, 0, 0, 0, 0, -f, 0, 0, 0, 0, (e + c) * g, -1, 0, 0, 2 * e * c * g, 0), this._curCamera = "custom";
        ...
        void 0 === a && (a = -this.width / 2), void 0 === b && (b = +this.width / 2), void 0 === c && (c = -this.height / 2), void 0 === e && (e = +this.height / 2), void 0 === f && (f = 0), void 0 === g && (g = Math.max(this.width, this.height)), this.uPMatrix = d.Matrix.identity(this._pInst);var h = b - a,
            i = e - c,
            j = g - f,
            k = 2 / h,
            l = 2 / i,
            ...
            n = -(b + a) / h,
            o = -(e + c) / i,
            p = -(g + f) / j;this.uPMatrix = d.Matrix.identity(), this.uPMatrix.set(k, 0, 0, 0, 0, -l, 0, 0, 0, 0, m, 0, n, o, p, 1), this._curCamera = "custom";
      }, b.exports = d;
      ...
      function d(a, b) {
        ...
        var b, c, f;"boolean" == typeof arguments[1] ? (b = arguments[1], c = arguments[2], f = arguments[3]) : (b = !1, c = arguments[1], f = arguments[2]);var g = new e.Geometry();return g.gid = a + "|" + b, this.loadStrings(a, function (a) {
      ...
      var d = a("../core/core"),
        ...
        this._renderer.GL.depthMask(!0), this._renderer.GL.enable(this._renderer.GL.BLEND), this._renderer.GL.blendFunc(this._renderer.GL.SRC_ALPHA, this._renderer.GL.ONE_MINUS_SRC_ALPHA), this._renderer.drawMode = e.TEXTURE;var b = this._renderer._useLightShader();return b.setUniform("uSpecular", !1), b.setUniform("isTexture", !0), b.setUniform("uSampler", a), this.noStroke(), this;
      }, d.prototype.ambientMaterial = function (a, b, c, e) {
        var f = d.prototype.color.apply(this, arguments);this._renderer.curFillColor = f._array;var g = this._renderer._useLightShader();return g.setUniform("uMaterialColor", this._renderer.curFillColor), g.setUniform("uSpecular", !1), g.setUniform("isTexture", !1), this;
      }, d.prototype.specularMaterial = function (a, b, c, e) {
        var f = d.prototype.color.apply(this, arguments);this._renderer.curFillColor = f._array;var g = this._renderer._useLightShader();return g.setUniform("uMaterialColor", this._renderer.curFillColor), g.setUniform("uSpecular", !0), g.setUniform("isTexture", !1), this;
      }, d.RendererGL.prototype._applyColorBlend = function (a) {
        var b = this.GL;return a[a.length - 1] < 1 ? (b.depthMask(!1), b.enable(b.BLEND), b.blendEquation(b.FUNC_ADD), b.blendFunc(b.SRC_ALPHA, b.ONE_MINUS_SRC_ALPHA)) : (b.depthMask(!0), b.disable(b.BLEND)), a;
      }, b.exports = d;
      ...
      var d = a("../core/core");d.Geometry = function (a, b, c) {
        ...
        var b = this.faces[a],
            ...
            j = d.Vector.mag(i),
            k = j / (d.Vector.mag(g) * d.Vector.mag(h));return i.mult(Math.asin(k) / j);
        ...
        for (var a = [], b = 0; b < this.vertices.length; b++) {
          for (var c = new d.Vector(), e = 0; e < this.faces.length; e++) {
            if (this.faces[e][0] === b || this.faces[e][1] === b || this.faces[e][2] === b) {
              var f = a[e] || (a[e] = this._getFaceNormal(e));c = c.add(f);
            }
        ...
        if (Array.isArray(this.strokeIndices)) for (var a = 0, b = this.strokeIndices.length; a < b; a++) {
        ...
        a.lineVertices = [];for (var b = 0; b < a.edges.length; b++) {
          var c = a.vertices[a.edges[b][0]],
              ...
              i = d.array(),
              j = e.array(),
              k = e.array();j.push(1), k.push(-1), a.lineNormals.push(j, k, j, j, k, k), a.lineVertices.push(f, g, h, h, g, i);
        }
      ...
      var d = a("../core/core"),
      ...
      };"undefined" != typeof Float32Array && (g = Float32Array, h = function h(a) {
        ...
        var b;if (a === this || a === this.mat4) b = this.copy().mat4;else if (a instanceof d.Matrix) b = a.mat4;else {
          if (!h(a)) return;b = a;
            ...
            e = this.mat4[1],
            f = this.mat4[2],
            g = this.mat4[3];return this.mat4[0] = c * b[0] + e * b[4] + f * b[8] + g * b[12], this.mat4[1] = c * b[1] + e * b[5] + f * b[9] + g * b[13], this.mat4[2] = c * b[2] + e * b[6] + f * b[10] + g * b[14], this.mat4[3] = c * b[3] + e * b[7] + f * b[11] + g * b[15], c = this.mat4[4], e = this.mat4[5], f = this.mat4[6], g = this.mat4[7], this.mat4[4] = c * b[0] + e * b[4] + f * b[8] + g * b[12], this.mat4[5] = c * b[1] + e * b[5] + f * b[9] + g * b[13], this.mat4[6] = c * b[2] + e * b[6] + f * b[10] + g * b[14], this.mat4[7] = c * b[3] + e * b[7] + f * b[11] + g * b[15], c = this.mat4[8], e = this.mat4[9], f = this.mat4[10], g = this.mat4[11], this.mat4[8] = c * b[0] + e * b[4] + f * b[8] + g * b[12], this.mat4[9] = c * b[1] + e * b[5] + f * b[9] + g * b[13], this.mat4[10] = c * b[2] + e * b[6] + f * b[10] + g * b[14], this.mat4[11] = c * b[3] + e * b[7] + f * b[11] + g * b[15], c = this.mat4[12], e = this.mat4[13], f = this.mat4[14], g = this.mat4[15], this.mat4[12] = c * b[0] + e * b[4] + f * b[8] + g * b[12], this.mat4[13] = c * b[1] + e * b[5] + f * b[9] + g * b[13], this.mat4[14] = c * b[2] + e * b[6] + f * b[10] + g * b[14], this.mat4[15] = c * b[3] + e * b[7] + f * b[11] + g * b[15], this;
        ...
        var h, i;h = this.p5 && this.p5._angleMode === f.DEGREES ? e.degreesToRadians(a) : a, b instanceof d.Vector ? (c = b.y, g = b.z, b = b.x) : b instanceof Array && (c = b[1], g = b[2], b = b[0]), i = Math.sqrt(b * b + c * c + g * g), b *= 1 / i, c *= 1 / i, g *= 1 / i;var j = this.mat4[0],
            k = this.mat4[1],
            l = this.mat4[2],
            m = this.mat4[3],
            n = this.mat4[4],
      ...
      var d = a("../core/core"),
        ...
        var h = this.GL;if (this.curFillShader.bindShader(), this.curFillShader.attributes.aPosition && (this._bindBuffer(this.immediateMode.vertexBuffer, h.ARRAY_BUFFER, this._vToNArray(this.immediateMode.vertices), Float32Array, h.DYNAMIC_DRAW), this.curFillShader.enableAttrib(this.curFillShader.attributes.aPosition.location, 3, h.FLOAT, !1, 0, 0)), this.drawMode === e.FILL && this.curFillShader.attributes.aVertexColor && (this._bindBuffer(this.immediateMode.colorBuffer, h.ARRAY_BUFFER, this.immediateMode.vertexColors, Float32Array, h.DYNAMIC_DRAW), this.curFillShader.enableAttrib(this.curFillShader.attributes.aVertexColor.location, 4, h.FLOAT, !1, 0, 0)), this.drawMode === e.TEXTURE && this.curFillShader.attributes.aTexCoord && (this._bindBuffer(this.immediateMode.uvBuffer, h.ARRAY_BUFFER, this.immediateMode.uvCoords, Float32Array, h.DYNAMIC_DRAW), this.curFillShader.enableAttrib(this.curFillShader.attributes.aTexCoord.location, 2, h.FLOAT, !1, 0, 0)), this.drawMode === e.FILL || this.drawMode === e.TEXTURE) switch (this.immediateMode.shapeMode) {case e.LINE_STRIP:case e.LINES:case e.TRIANGLES:
            this.immediateMode.shapeMode = e.TRIANGLE_FAN;} else switch (this.immediateMode.shapeMode) {case e.LINE_STRIP:case e.LINES:
      ...
      "use strict";
      var d = a("../core/core"),
          e = a("../core/constants");a("./p5.Shader"), a("../core/p5.Renderer"), a("./p5.Matrix");var f = [],
          g = [],
        ...
        var c;void 0 !== b ? (c = {}, c[a] = b) : a instanceof Object && (c = a), this._renderer._resetContext(c);
        ...
        arguments[3] = 255;var f = d.prototype.color.apply(this._pInst, arguments);this.curStrokeColor = f._array, this.curStrokeShader.setUniform("uMaterialColor", this.curStrokeColor);
        ...
        var b = function b(_b2) {
          return _b2.src === a;
            ...
            c = this.textures.find(b);return c || (c = new d.Texture(this, a), this.textures.push(c)), c;
      ...
      "use strict";
      var d = a("../core/core");d.Shader = function (a, b, c) {
        ...
        var c = this.uniforms[a];if (c) {
          var d = c.location,
              ...
              c.size > 1 ? e.uniform1iv(d, b) : e.uniform1i(d, b);break;case e.FLOAT:
              c.size > 1 ? e.uniform1fv(d, b) : e.uniform1f(d, b);break;case e.FLOAT_MAT3:
              e.uniformMatrix3fv(d, !1, b);break;case e.FLOAT_MAT4:
              e.uniformMatrix4fv(d, !1, b);break;case e.FLOAT_VEC2:
              c.size > 1 ? e.uniform2fv(d, b) : e.uniform2f(d, b[0], b[1]);break;case e.FLOAT_VEC3:
              c.size > 1 ? e.uniform3fv(d, b) : e.uniform3f(d, b[0], b[1], b[2]);break;case e.FLOAT_VEC4:
              c.size > 1 ? e.uniform4fv(d, b) : e.uniform4f(d, b[0], b[1], b[2], b[3]);break;case e.SAMPLER_2D:
      ...
      "use strict";
      var d = a("../core/core");d.Texture = function (a, b) {
        ...
        var a;return this.isSrcP5Image ? a = this.src.canvas : (this.isSrcMediaElement || this.isSrcP5Graphics || this.isSrcHTMLElement) && (a = this.src.elt), a;
      ...
      "use strict";
      var d = a("../core/core");a("./p5.Geometry"), d.prototype.plane = function (a, b, c, e) {
        void 0 === a && (a = 50), void 0 === b && (b = a), void 0 === c && (c = 1), void 0 === e && (e = 1);var f = "plane|" + c + "|" + e;if (!this._renderer.geometryInHash(f)) {
          var g = function g() {
            for (var a, b, c, e = 0; e <= this.detailY; e++) {
              ...
              h = new d.Geometry(c, e, g);h.computeFaces().computeNormals(), c <= 1 && e <= 1 ? (h._makeTriangleEdges(), this._renderer._edgesToVertices(h)) : console.log("Cannot draw stroke on plane objects with more than 1 detailX or 1 detailY"), this._renderer.createBuffers(f, h);
        }this._renderer.drawBuffersScaled(f, a, b, 0);
      }, d.prototype.box = function (a, b, c, e, f) {
        void 0 === a && (a = 50), void 0 === b && (b = a), void 0 === c && (c = b), void 0 === e && (e = 4), void 0 === f && (f = 4);var g = "box|" + e + "|" + f;if (!this._renderer.geometryInHash(g)) {
          var h = function h() {
            var a = [[0, 4, 2, 6], [1, 3, 5, 7], [0, 1, 4, 5], [2, 6, 3, 7], [0, 2, 1, 3], [4, 5, 6, 7]];this.strokeIndices = [[0, 1], [1, 3], [3, 2], [6, 7], [8, 9], [9, 11], [14, 15], [16, 17], [17, 19], [18, 19], [20, 21], [22, 23]];for (var b = 0; b < a.length; b++) {
              ...
              i = new d.Geometry(e, f, h);i.computeNormals(), e <= 4 && f <= 4 ? (i._makeTriangleEdges(), this._renderer._edgesToVertices(i)) : console.log("Cannot draw stroke on box objects with more than 4 detailX or 4 detailY"), this._renderer.createBuffers(g, i);
        ...
        _e2 = _e2 < 3 ? 3 : _e2, f = f < 1 ? 1 : f, g = void 0 === g || g, h = void 0 === h || h;var i,
            j,
            k = (g ? 2 : 0) + (h ? 2 : 0),
            l = _e2 + 1,
            m = Math.atan2(a - b, c),
            n = g ? -2 : 0,
            o = f + (h ? 2 : 0);for (i = n; i <= o; ++i) {
          var p,
              q = i / f,
              r = c * q;for (i < 0 ? (r = 0, q = 1, p = a) : i > f ? (r = c, q = 1, p = b) : p = a + i / f * (b - a), -2 !== i && i !== f + 2 || (p = 0, q = 0), r -= c / 2, j = 0; j < l; ++j) {
            this.vertices.push(new d.Vector(Math.sin(j * Math.PI * 2 / _e2) * p, r, Math.cos(j * Math.PI * 2 / _e2) * p)), this.vertexNormals.push(new d.Vector(i < 0 || i > f ? 0 : Math.sin(j * Math.PI * 2 / _e2) * Math.cos(m), i < 0 ? -1 : i > f ? 1 : Math.sin(m), i < 0 || i > f ? 0 : Math.cos(j * Math.PI * 2 / _e2) * Math.cos(m))), this.uvs.push([j / _e2, q]);
          }
        }for (i = 0; i < f + k; ++i) {
          for (j = 0; j < _e2; ++j) {
        ...
        void 0 === a && (a = 50), void 0 === b && (b = a), void 0 === c && (c = 24), void 0 === f && (f = 16);var g = "cylinder|" + c + "|" + f;if (!this._renderer.geometryInHash(g)) {
          var h = new d.Geometry(c, f);e.call(h, 1, 1, 1, c, f, !0, !0), h.computeNormals(), c <= 24 && f <= 16 ? (h._makeTriangleEdges(), this._renderer._edgesToVertices(h)) : console.log("Cannot draw stroke on cylinder objects with more than 24 detailX or 16 detailY"), this._renderer.createBuffers(g, h);
        }return this._renderer.drawBuffersScaled(g, a, a, b), this;
      }, d.prototype.cone = function (a, b, c, f) {
        void 0 === a && (a = 50), void 0 === b && (b = a), void 0 === c && (c = 24), void 0 === f && (f = 16);var g = "cone|" + a + "|" + b + "|" + c + "|" + f;if (!this._renderer.geometryInHash(g)) {
          var h = new d.Geometry(c, f);e.call(h, a, 0, b, c, f, !0, !0), h.computeNormals(), c <= 24 && f <= 16 ? (h._makeTriangleEdges(), this._renderer._edgesToVertices(h)) : console.log("Cannot draw stroke on cone objects with more than 24 detailX or 16 detailY"), this._renderer.createBuffers(g, h);
        }return this._renderer.drawBuffers(g), this;
      }, d.prototype.ellipsoid = function (a, b, c, e, f) {
        void 0 === a && (a = 50), void 0 === b && (b = a), void 0 === c && (c = a), void 0 === e && (e = 24), void 0 === f && (f = 16);var g = "ellipsoid|" + e + "|" + f;if (!this._renderer.geometryInHash(g)) {
          var h = function h() {
            for (var a = 0; a <= this.detailY; a++) {
              ...
              i = new d.Geometry(e, f, h);i.computeFaces(), e <= 24 && f <= 24 ? (i._makeTriangleEdges(), this._renderer._edgesToVertices(i)) : console.log("Cannot draw stroke on ellipsoids with more than 24 detailX or 24 detailY"), this._renderer.createBuffers(g, i);
        }return this._renderer.drawBuffersScaled(g, a, b, c), this;
      }, d.prototype.torus = function (a, b, c, e) {
        if (void 0 === a) a = 50;else if (!a) return;if (void 0 === b) b = 10;else if (!b) return;void 0 === c && (c = 24), void 0 === e && (e = 16);var f = (b / a).toPrecision(4),
          ...
          var h = function h() {
            for (var a = 0; a <= this.detailY; a++) {
              ...
              i = new d.Geometry(c, e, h);i.computeFaces(), c <= 24 && e <= 16 ? (i._makeTriangleEdges(), this._renderer._edgesToVertices(i)) : console.log("Cannot draw strokes on torus object with more than 24 detailX or 16 detailY"), this._renderer.createBuffers(g, i);
        ...
        var b = a[0],
          ...
          var j = function j() {
            var a = [];a.push(new d.Vector(0, 0, 0)), a.push(new d.Vector(0, 1, 0)), a.push(new d.Vector(1, 0, 0)), this.strokeIndices = [[0, 1], [1, 2], [2, 0]], this.vertices = a, this.faces = [[0, 1, 2]], this.uvs = [[0, 0], [0, 1], [1, 1]];
              ...
              k = new d.Geometry(1, 1, j);k._makeTriangleEdges(), this._edgesToVertices(k), k.computeNormals(), this.createBuffers(i, k);
        ...
        var b = a[0],
            ...
            f = a[3],
            g = a[4] || 24,
            h = "ellipse|" + g;if (!this.geometryInHash(h)) {
          var i = function i() {
            this.vertices.push(new d.Vector(.5, .5, 0)), this.uvs.push([.5, .5]);for (var a = 0; a <= this.detailX; a++) {
              var b = a / this.detailX,
                  c = 2 * Math.PI * b,
                  e = .5 + Math.cos(c) / 2,
                  f = .5 + Math.sin(c) / 2;this.vertices.push(new d.Vector(e, f, 0)), this.uvs.push([e, f]), this.faces.push([0, (a + 1) % this.detailX + 1, a + 1]);
            }
          },
              j = new d.Geometry(g, 1, i);j.computeNormals(), g <= 50 ? (j._makeTriangleEdges(), this._edgesToVertices(j)) : console.log("Cannot stroke ellipse with more than 50 detailX"), this.createBuffers(h, j);
        ...
        var b = a[0],
            ...
            g = a[4] || 24,
            h = a[5] || 16,
            i = "rect|" + g + "|" + h;if (!this.geometryInHash(i)) {
          var j = function j() {
            for (var a = 0; a <= this.detailY; a++) {
              ...
              k = new d.Geometry(g, h, j);k.computeFaces().computeNormals()._makeTriangleEdges(), this._edgesToVertices(k), this.createBuffers(i, k);
        }var l = this.uMVMatrix.copy();try {
        ...
        var j = "quad|" + a + "|" + b + "|" + c + "|" + e + "|" + f + "|" + g + "|" + h + "|" + i;if (!this.geometryInHash(j)) {
          var k = function k() {
            this.vertices.push(new d.Vector(a, b, 0)), this.vertices.push(new d.Vector(c, e, 0)), this.vertices.push(new d.Vector(f, g, 0)), this.vertices.push(new d.Vector(h, i, 0)), this.uvs.push([0, 0], [1, 0], [1, 1], [0, 1]), this.strokeIndices = [[0, 1], [1, 2], [2, 3], [3, 0]];
              ...
              l = new d.Geometry(2, 2, k);l.computeNormals()._makeTriangleEdges(), this._edgesToVertices(l), l.faces = [[0, 1, 2], [2, 3, 0]], this.createBuffers(j, l);
        }return this.drawBuffers(j), this;
      }, d.RendererGL.prototype.bezier = function (a, b, c, d, e, f, g, h, i, j, k, l) {
        var m = this._pInst._bezierDetail || 20;this.beginShape();for (var n = 0; n <= m; n++) {
        ...
        var m = this._pInst._curveDetail;this.beginShape();for (var n = 0; n <= m; n++) {
